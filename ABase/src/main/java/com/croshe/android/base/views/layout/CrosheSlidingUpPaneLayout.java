...
public class CrosheSlidingUpPaneLayout extends ViewGroup {
    ...
    public CrosheSlidingUpPaneLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CrosheSlidingUpPaneLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mInitialMotionY > mEdgeSlop && !isOpen() && canScroll(this, false,
                        Math.round(y - mInitialMotionY), Math.round(x), Math.round(y))) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP: {
                if (mPanelSlideListener != null) {
                    mPanelSlideListener.onPanelTouchUp();
                }
                if (!canOpen) {
    ...
    public void draw(Canvas canvas) {
        ...
        int shadowHeight = shadowDrawable.getIntrinsicHeight();
        final int top;
        final int bottom;
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == CrosheSlidingUpPaneLayout.this) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(CrosheSlidingUpPaneLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(CrosheSlidingUpPaneLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(CrosheSlidingUpPaneLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(CrosheSlidingUpPaneLayout.class.getName());
        }
