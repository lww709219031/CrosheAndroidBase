 ...
 * 波浪侧边栏
 */
public class CrosheWaveSideBarView extends View {
    ...
    public CrosheWaveSideBarView(Context context) {
        this(context, null);
    }

    public CrosheWaveSideBarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CrosheWaveSideBarView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mWaveColor = BaseAppUtils.getColorAccent(context);
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.CrosheWaveSideBarView);
            mTextColor = a.getColor(R.styleable.CrosheWaveSideBarView_sidebarTextColor, mTextColor);
            mTextColorChoose = a.getColor(R.styleable.CrosheWaveSideBarView_sidebarChooseTextColor, mTextColorChoose);
            mTextSize = a.getFloat(R.styleable.CrosheWaveSideBarView_sidebarTextSize, mTextSize);
            mLargeTextSize = a.getFloat(R.styleable.CrosheWaveSideBarView_sidebarLargeTextSize, mLargeTextSize);
            mWaveColor = a.getColor(R.styleable.CrosheWaveSideBarView_sidebarBackgroundColor, mWaveColor);
            mRadius = a.getInt(R.styleable.CrosheWaveSideBarView_sidebarRadius, context.getResources().getDimensionPixelSize(R.dimen.radius_sidebar));
            mBallRadius = a.getInt(R.styleable.CrosheWaveSideBarView_sidebarBallRadius, context.getResources().getDimensionPixelSize(R.dimen.ball_radius_sidebar));
            a.recycle();
        }
