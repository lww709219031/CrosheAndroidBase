...
public class CrosheHMenuLayout extends FrameLayout {
    ...
    private int leftIcon,rightIcon,rightIconColor;
    ...
    public CrosheHMenuLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initValue(attrs);
        initView();
    }

    public CrosheHMenuLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void initView() {
        ...
        rightImgIcon = (ImageView) findViewById(R.id.rightImgIcon);
        ...
        VectorDrawableCompat vectorDrawableCompat = VectorDrawableCompat.create(getResources(),
                R.drawable.android_base_ic_right_arrow, getContext().getTheme());
        //你需要改变的颜色
        vectorDrawableCompat.setTint(rightIconColor);
        rightImgIcon.setImageDrawable(vectorDrawableCompat);
    ...
    public void initValue() {
        if (rightIcon != -1) {
            rightImgIcon.setImageResource(rightIcon);
        }
        ...
        if (leftIconHidden) {
            leftImgIcon.setVisibility(GONE);
        }else{
            leftImgIcon.setVisibility(VISIBLE);
        }

        if (rightIconHidden) {
            rightImgIcon.setVisibility(GONE);
        }else{
            rightImgIcon.setVisibility(VISIBLE);
        }
    ...
    private void initValue(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.CrosheHMenuLayout);
            leftIcon = a.getResourceId(R.styleable.CrosheHMenuLayout_hmenu_leftIcon, -1);
            text = a.getString(R.styleable.CrosheHMenuLayout_hmenu_text);
            subtext = a.getString(R.styleable.CrosheHMenuLayout_hmenu_subtext);
            rightIcon = a.getResourceId(R.styleable.CrosheHMenuLayout_hmenu_rightIcon, -1);
            rightIconColor = a.getColor(R.styleable.CrosheHMenuLayout_hmenu_rightIconColor, Color.parseColor("#cccccc"));

            textSize = a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_textSize, DensityUtils.dip2px(16));
            subtextSize = a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_subtextSize, DensityUtils.dip2px(16));

            textColor = a.getColor(R.styleable.CrosheHMenuLayout_hmenu_textColor, Color.parseColor("#444444"));
            subtextColor = a.getColor(R.styleable.CrosheHMenuLayout_hmenu_subtextColor, Color.parseColor("#cccccc"));


            tipNumber = a.getString(R.styleable.CrosheHMenuLayout_hmenu_tipNumber);
            leftIconHidden = a.getBoolean(R.styleable.CrosheHMenuLayout_hmenu_leftIconHidden, false);
            rightIconHidden = a.getBoolean(R.styleable.CrosheHMenuLayout_hmenu_rightIconHidden, false);

            topLineWidth = a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_topLineWidth,0);
            bottomLineWidth = a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_bottomLineWidth, 0);
            leftLineWidth = a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_leftLineWidth, 0);
            rightLineWidth = a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_rightLineWidth, 0);
            lineColor = a.getColor(R.styleable.CrosheHMenuLayout_hmenu_lineColor, Color.parseColor("#cccccc"));


            lineMarginLeft = a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_lineMarginLeft, 0);
            lineMarginTop = a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_lineMarginTop,0);
            lineMarginRight = a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_lineMarginRight, 0);
            lineMarginBottom= a.getDimensionPixelSize(R.styleable.CrosheHMenuLayout_hmenu_lineMarginBottom, 0);
    ...
    public boolean isLeftIconHidden() {
        return leftIconHidden;
    }

    public void setLeftIconHidden(boolean leftIconHidden) {
        this.leftIconHidden = leftIconHidden;
    }

    public boolean isRightIconHidden() {
        return rightIconHidden;
    }

    public void setRightIconHidden(boolean rightIconHidden) {
        this.rightIconHidden = rightIconHidden;
    }
}
