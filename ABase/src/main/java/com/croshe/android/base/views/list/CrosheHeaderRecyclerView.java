...
public class CrosheHeaderRecyclerView<T> extends FrameLayout implements  OnCrosheRecyclerDataListener<T> {
    ...
    public CrosheHeaderRecyclerView(@NonNull Context context) {
        super(context);
        initView();
    }

    public CrosheHeaderRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public CrosheHeaderRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        if (onCrosheHeaderListener != null) {
            onCrosheHeaderListener.getData(page, new PageDataCallBack<T>() {
                ...
                public boolean loadData(int page, List<T> data, int appendIndex,
                    ...
                    if (page == -1) {
                        page = CrosheHeaderRecyclerView.this.page;
                    }
